...
type config struct {
	...
	PostgresAddress  string `envconfig:"PSQL_ADDRESS" default:"127.0.0.1:5432" validate:"required,hostname_port"`
	...
	PostgresDatabase string `envconfig:"PSQL_DATABASE" validate:"required"`
